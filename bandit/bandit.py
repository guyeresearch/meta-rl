...
# -*- coding: utf-8 -*-
"""
copied and modified from tristandeleu/pytorch-maml-rl
...
class BernoulliBanditDependantEnv(BernoulliBanditEnv):
    def __init__(self):
        super(BernoulliBanditDependantEnv, self).__init__(k=2)
        
    def sample_tasks(self):
        mean = self.np_random.rand(1,1)[0][0]
        return [{'mean': np.array([mean, 1-mean])}]
